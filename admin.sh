...
# run flask
gcloud run deploy admin-flask --image $REPOSITORY/workspace_flask:$COMMIT_SHA --platform managed --add-cloudsql-instances sales-engineering-sf:
us-central1:tracing-db-pg --update-env-vars INSTANCE_CONNECTION_NAME="sales-engineering-sf:us-central1:tracing-db-pg"
# run react
